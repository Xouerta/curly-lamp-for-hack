...
int main(void)
{
 ...
 printf("国王忧急万分，他向全国发出了号召，哪位勇士能杀死恶龙，救出公主，就\n把公主许配给他,并在今后继承王位！\n");
  ...
  int a=0,b=0,c = 0,d=0,e=0,f=0,g=0,m=0,n=0,criminal=0;/*定义几个形参*/
  ...
  do{
   ...
   printf("  你现在有金币%d个。\n你现在可以去:\n",gold);
  printf("1.恶龙城堡 2.武器铺 3.旅店 4.练武馆 5.医院 6.赌场\n");
  scanf("%d", &c); 
  switch (c){
  case 1: /*恶龙城堡*/ {
  ...
  case 3:/*旅店*/ {
   ...
   if (d!=6)
   {
	...
	printf("那神秘人说：“哈哈,没想到你还这么有礼貌，我赠与你一个祝福......”你感觉你的力量在增强！\n");
      ...
      break;}
    case 3:{printf("老板谈论着关于自己的旅店经常有扒手的问题...并问你是否愿意想当酒馆的保安，你礼貌地回绝了他，毕竟一个王国的兴衰都在你手上！");break;} 
  ...
  printf("恶龙吼道：“凡人！休得谮越！”");
  int hp3 = 1500,atk3=0 ;/*定义敌人血量、攻击力*/
 ...
 do{
   ...
   state(hp,hp2,mp,mp2,atk);
   printf("  你现在有金币%d个。\n你现在可以去:\n",gold);
  printf("1.圣龙所在的世界之巅 2.神级武器铺 3.旅店 4.神殿 5.医院 6.赌场\n");
  scanf("%d", &c1); 
  switch (c1){
  case 1: /*恶龙城堡*/ {
  ...
  int hp5 = 9500,atk5=0 ;/*定义敌人血量、攻击力*/
